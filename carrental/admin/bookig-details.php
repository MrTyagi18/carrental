...
<head>
	...
	<title>Car Rental Management | New Bookings   </title>
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
				...
				<a href="bookig-details.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Confirm this booking')" class="btn btn-primary"> Confirm</a> 

<a href="bookig-details.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')" class="btn btn-danger"> Cancel</a>
</td>
</tr>
<?php } ?>
										<?php $cnt=$cnt+1; }} ?>
